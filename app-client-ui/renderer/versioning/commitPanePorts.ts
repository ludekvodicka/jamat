...
export interface CommitPanePorts {
  versioning: Pick<AppClientUiBridge['versioning'], 'openDraft' | 'readCommit' | 'commitFiles' | 'setCommitMessage' | 'runCommit' | 'closeCommit' | 'getSettings' | 'saveSettings' | 'externalDiff' | 'revertCommitFile' | 'openTortoise'>
